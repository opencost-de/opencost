...
| 2.1       | `doi`                       | Possible value: `doi`                                                                                                                                                                                                  | String      | No       | Choice     | Digital Object Identifier (doi) to identify the publication. Serves as primary identifier.                                                                                                                                                                                                              |
...
| 4.2       | `name`                      |                                                                                                                                                                                                                        |             | Yes      | Coice     | Defines the institution which pays for the publication. The names are meant to be human-readable. Either this element or the institution's `id` is required.                                                                                                                                                |
...
| 7.2.3.1   | `invoice`                   | Format: `YYYY-MM-DD`, `YYYY-MM` or `YYYY`                                                                                                                                                                              | Pattern     | No       | Coice     | Invoice date. Can be a certain day, month of year, or just a year. Either this element or date paid is required.                                                                                                                                                                                        |
