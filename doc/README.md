...
publication [1]
    ...
    |           |--- value [4.2.2]
    |       
    |--- publication_type = COAR controlled vocabulary (v3.2) / COAR PURL [5]                   
    |  
...
| 4.1.1     | `type`                      | Possible values: `ror`, `isni`, `ringgold`                                                                                                                                                                              | Enumeration | No      | Yes       |
| 4.1.2     | `value`                     |                                                                                                                                                                                                                        | String      | No      | Yes       |       |
...
| 4.2.1     | `type`                      | Possible values: `full`, `short`                                                                                                                                                                                       | Enumeration | No      | Yes     |                                                                                                                                     |
| 4.2.2     | `value`                     |                                                                                                                                                                                                                        | String      | No      | Yes     |                                                                                                                                |
| 5         | `publication_type`          | Possible values: [COAR controlled vocabulary v3.2](https://vocabularies.coar-repositories.org/resource_types/) or corresponding COAR PURL                                                                                                             | Enumeration | No       | Yes       | This field explains the type of the publication, how the reporting institutions categorize it. Maybe this will differ from the publication type mentioned by publisher, databases or elsewhere. Values may be expressed either as the English labels from the COAR Controlled Vocabulary (v3.2) or as the corresponding COAR PURLs. The use of COAR PURLs is recommended because as persistent identifiers they provide a language-independent representation of publication types. However, the English labels remain valid and fully supported.                                                                                                       |
...
| 7.2.5.1   | `amount_paid`               |                                                                                                                                                                                                                        |             | Yes      | Yes       | A single amount paid by the institution, usually corresponding to an item on the invoice. Is defined by the child elements `amount`, `currency`, `cost_type` and `vat`.                                                                                                                                              
| 7.2.5.1.1 | `amount`                    | Net monetary value. Negative or zero values are valid to denote reimbursements or Diamond OA models.                                                                                                                   | Number      | No       | Yes       | Amount of the `amount_paid`.                                                                                                                                                                                                                                                                                 |
| 7.2.5.1.2 | `currency`                  | Currency has to be a three-letter, upper case string (`EUR`, `USD` etc.) according to [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217).                                                                              | Pattern     | No       | Yes       | Currency of the `amount_paid`.                                                                                                                                                                                                                                                                              |
| 7.2.5.1.3 | `cost_type`                 | Possible values: `gold-oa`, `hybrid-oa`, `vat`*, `colour charge`, `cover charge`, `page charge`, `permission`, `publication charge`, `reprint`, `submission fee`, `payment fee` or `other`.                             | Enumeration | No       | Yes       | `cost_type` describes the object/purpose of the payment. * If the vat cannot be subdivided specifically for the individual cost types, but only for the total amount of the invoice, a separate entry with the `cost_type` `vat` is also possible here (7.2.5.1.3) instead of the specification `vat` (7.2.5.1.4).                                                                                                                                                                                                                                        |
| 7.2.5.1.4 | `vat`                  | Vat monetary value. State in the same currency as amount. | Number     | No       | Choice       | Vat of the `amount_paid`. `vat` must be specified and assigned according to the individual cost type. If a differentiated specification is not possible, please refer to 7.2.5.1.3.                                                                                                                                                                                                                                                                                                          |
...
| 3.1.1       | `type`                  | Possible values: `ror`, `isni`, `ringgold`.                                                                                                | Enumeration | No       | Yes	     |                                                                                                                                                                                                  |
| 3.1.2       | `value`                 |                                                                                                                                            | String      | No       | Yes      |                                                                                                                                                                                                    |
...
| 7.1.3       | `invoice`               |                                                                                                                                            |             | Yes      | No       | An `invoice` block encapsulates payment information for a contract and is meant to correspond to a real-world invoice. Can occur more than once to handle the case of multiple invoices for a single contract.                                                                                                                                                              |
...
| 7.1.3.5.1   | `amount_paid`           |                                                                                                                                            |             | Yes      | Yes      | An amount paid by the institution, usually corresponding to an item on the invoice. Is defined by the child elements `amount`, `currency`, `cost_type` and `vat`.                                                                                                                                                                                                                  |
| 7.1.3.5.1.1 | `amount`                | Net monetary value. Negative or zero values are valid to denote reimbursements.                                                            | Number      | No       | Yes      | Amount of the `amount_paid`.                                                                                                                                                                                                                                                                                                                                                  |
| 7.1.3.5.1.2 | `currency`              | Currency has to be a three-letter, upper case string (`EUR`, `USD` etc.) according to [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217).  | Pattern     | No       | Yes      | Currency of the `amount_paid`.                                                                                                                                                                                                                                                                                                                                                |
| 7.1.3.5.1.3 | `cost_type`             | Possible values: `publish`, `read`, `publish and read`, `service fee` or `vat`*                                                            | Enumeration | No       | Yes      | cost_type describes the object/purpose of the payment. * If the vat cannot be subdivided specifically for the individual cost types, but only for the total amount of the invoice, a separate entry with the `cost_type` `vat` is also possible here (7.1.3.5.1.3) instead of the specification `vat` (7.1.3.5.1.4).                                                                                                                                                                                                                                                                                                                      |
| 7.1.3.5.1.4 | `vat`             | Vat monetary value. State in the same currency as amount.                                                                                               | Number | No       | Choice      | Vat of the `amount_paid`. `vat` must be specified and assigned according to the individual cost type. If a differentiated specification is not possible, please refer to 7.1.3.5.1.3.                                                                                                                                                                                                                                                                                                                      |
