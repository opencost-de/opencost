...
- openCost uses [COAR Resource types v3.2](https://vocabularies.coar-repositories.org/resource_types/3.2/). The schema also supports specifying document types via the PURLs defined in COAR.
