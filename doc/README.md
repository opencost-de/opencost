...
| `id`                        | Secondary identifier for the contract. Possible values: `oai`, `ezb`.                                                                                                                                                                                                                                                                                                  | String     | Yes          | No             | No                   | Optional set of additional (persistent) identifiers. Each type may occur more than once.                                                                                                                                                                                  |
