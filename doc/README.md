...
- openCost uses [COAR Resource types v3.2](https://vocabularies.coar-repositories.org/resource_types/3.2/). The schema also supports specifying publication types via the corresponding PURLs defined in COAR. The use of COAR PURLs is recommended because as persistent identifiers they provide a language-independent representation of publication types.
...
| 4.1.1     | `type`                      | Possible values: `ror`, `isni`, `ringold`                                                                                                                                                                              | Enumeration | No      | Yes       |
